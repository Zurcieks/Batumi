    ...
    <div className="mx-auto px-4 py-8">
      ...
      <div className="flex flex-col justify-center lg:flex-row">
        ...
        <div className="lg:w-1/4 lg:pl-6 mt-6 lg:mt-24 bg-gray-50 p-6 rounded-lg shadow-md">
          ...
          <ul className="text-gray-700 space-y-1">
            <li>Cena: {offer.price} PLN</li>
            <li>Powierzchnia: {offer.area} m²</li>
            <li>Numer piętra: {offer.floors}</li>
            <li>Liczba pokoi: {offer.rooms}</li>
            <li>Liczba sypialni: {offer.bedrooms}</li>
            <li>Liczba łazienek: {offer.bathrooms}</li>
          </ul>
          ...
          <ul className="text-gray-700 space-y-1">
            <li>Rok budowy: {offer.yearBuild}</li>
          </ul>
          ...
          >
            <FaArrowLeft className="mr-2" /> Wróć do listy
          </Link>
        </div>
      </div>
