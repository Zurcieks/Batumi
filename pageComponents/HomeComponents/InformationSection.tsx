...
const InformationSection: React.FC = () => {
  ...
  return (
    <section className="bg-red-100 py-6">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 text-left">
          <div
            ref={ref1}
            className={`flex items-center transform transition-transform duration-1000 ${inView1 ? "translate-x-0 opacity-100" : "-translate-x-10 opacity-0"}`}
          >
          ...
          <div
            ref={ref3}
            className={`flex items-center transform transition-transform duration-1000 ${inView3 ? "translate-x-0 opacity-100" : "translate-x-10 opacity-0"}`}
          >
